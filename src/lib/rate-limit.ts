...
export const RATE_LIMITS = {
  ...
  /** Login attempt (public, per-IP+email). Bounds password brute-force
   *  and stops email-bombing via the 2FA code sender. */
  login: { limit: 10, windowMs: 60_000 },
  /** 2FA code verification (public, per-IP+challenge). Tighter — pairs
   *  with the per-challenge attempt counter to make code-guessing
   *  against the 10^6 space infeasible. */
  login2fa: { limit: 12, windowMs: 60_000 },
