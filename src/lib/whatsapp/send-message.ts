...
export async function sendMessageToConversation(
  ...
  // ¿Cuenta demo? El envío saliente puentea Meta (simulador de ventas):
  // no hay número real conectado, así que el mensaje solo se persiste
  // localmente y fluye por el pipeline. Las cuentas reales (is_demo=false)
  // no cambian en nada.
  ...
  // En demo nunca se disparan conversiones reales (Meta CAPI / Google Ads).
