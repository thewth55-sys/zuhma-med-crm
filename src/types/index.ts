...
export interface Contact {
  ...
  name?: string;
  /** Split-name fields (migration 075). `name` is kept in sync from
   *  these by the `sync_contact_name` trigger; the rest of the app still
   *  reads `name`. */
...
export interface PatientProfile {
  ...
  notes?: string | null;
  /** Campos administrativos/clínicos ricos (migración 075). */
...
/** Responsable/tutor reutilizable (migración 075) — pediatría y
 *  veterinaria. Se vincula a uno o varios pacientes vía patient_guardians. */
...
/** Vínculo paciente(contacto) ↔ responsable. */
export interface PatientGuardian {
  ...
  is_primary: boolean;
  created_at: string;
  /** Hidratado cuando la consulta embebe guardians(*). */
  guardian?: Guardian;
}
...
/** Aviso de plataforma (migración 082) mostrado en el dashboard del usuario. */
