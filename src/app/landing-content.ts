...
export const STRUCTURED_DATA = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemReviewed: { "@id": "https://app.zuhma.com/#service" },
      ratingValue: "5",
      bestRating: "5",
      ratingCount: "80",
    },
...
<section class="hero">
  <div class="wrap">
    ...
    <img class="hero-illus-img" src="/landing/hero-product.png" alt="Equipo completo de Zuhma Med CRM: estratega, ads manager, content creator, CRM y agenda, WhatsApp IA" width="1672" height="941" />
  </div>
</section>
...
<section class="diff-section">
  <div class="wrap">
    <div class="diff-header reveal">
      ...
      <p class="section-sub" style="color:rgba(255,255,255,.45);margin:12px auto 0;">La mayoría de consultorios tiene que elegir uno o el otro. Zuhma Med CRM elimina esa decisión — y te cuesta menos que un asistente administrativo.</p>
    </div>
    <div class="diff-cols reveal-group">
      ...
      <div class="diff-col diff-col-good">
        <div class="diff-col-label">
          <div class="diff-icon">✓</div>
          <span>Zuhma Med CRM — 2 en 1</span>
        </div>
        <ul class="diff-list">
    ...
    <img class="illus-img reveal" src="/landing/vs-comparison.png" alt="Comparación: consultorio sin Zuhma Med CRM (caos, sin seguimiento) vs. con Zuhma Med CRM (equipo médico, WhatsApp, agenda y campañas activas)" width="1672" height="941" style="max-width:860px;margin:32px auto 0;" />
  ...
  <div class="wrap">
    <div class="solution-grid reverse">
      ...
      <div class="solution-visual" style="background:var(--zm-night2);">
        <img class="illus-img" src="/landing/marketing-dashboard.png" alt="Dashboard de campañas de marketing de Zuhma Med CRM: ROAS, pacientes nuevos y costo por lead en Meta y Google Ads" width="1672" height="941" />
        <div>
  ...
  <div class="wrap">
    ...
    <p style="text-align:center;margin-top:24px;font-size:12px;color:var(--zm-muted2);font-family:'JetBrains Mono',monospace;line-height:1.8;">
      * El presupuesto de pauta (Meta/Google Ads) va directo a tu cuenta — Zentro gestiona las campañas, tú controlas el dinero.<br>
      ...
      Zuhma Med CRM es una plataforma de gestión comercial y marketing. No es un software de historia clínica ni de facturación tributaria.
    </p>
  </div>
</section>
