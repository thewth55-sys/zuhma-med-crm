// Static content for the alternate CRM-focused marketing landing
// (src/app/crm/page.tsx) — a separate page from the root "/" landing,
// not a replacement. Split out from the page component so the ~40KB
// of embedded CSS/HTML/script string constants aren't all resident in
// the same module as the component + its imports — keeps each
