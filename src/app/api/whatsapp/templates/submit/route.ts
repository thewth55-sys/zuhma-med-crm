...
export async function POST(request: Request) {
  try {
    // Submitting a real template to Meta (and persisting it) is an
    // account-wide settings change — canEditSettings() documents this
    // as admin+ only, same as whatsapp_config.
