-- ============================================================
-- 040_platform_billing.sql — Zuhma Med SaaS layer: plans,
...
--     orthogonal on purpose: a `salud_pro` account can be
...
--     row in the separate the billing portal (different repo, PHP/
...
--     account. A platform admin belongs to Zuhma Med itself, not to
