...
Thanks for taking the time to look into the security of Zuhma Med.
...
- [GitHub Security Advisories](https://github.com/thewth55-sys/zuhma-med-crm/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `soporte@zuhma.com` with `[Zuhma Med security]` in the subject.
...
In scope:
- Anything in this repository (`thewth55-sys/zuhma-med-crm`), including webhook and auth
...
Thanks for helping keep Zuhma Med safe.
